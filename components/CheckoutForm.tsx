...
export default function CheckoutForm({ selectedData, onBack, prefillData }: any) {
  ...
  const redirectToContent = (data: any) => {
    ...
    } else if (["cat-a","cat-b","cat-c"].includes(selectedCatId)) {
  ...
  return (
    <div className="min-h-screen flex flex-col" dir={isRtl ? "rtl" : "ltr"}
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-[0.02]" style={{ backgroundImage: "radial-gradient(circle, #ffffff 1px, transparent 1px)", backgroundSize: "28px 28px" }}></div>
      </div>
      ...
      <div className="relative z-10 px-4 pt-6 pb-4 flex items-center gap-3">
        ...
        <div>
          <p className="text-white/40 text-xs font-bold uppercase tracking-wider">
            {lang === "ar" ? "إتمام الاشتراك" : lang === "nl" ? "Inschrijving voltooien" : "Finaliser l'inscription"}
          </p>
      ...
      <div className="relative z-10 flex-1 px-4 pb-8">
        ...
        {successMsg && (
          <div className="mb-4 px-5 py-4 rounded-2xl text-center font-black text-sm"
            style={{ background: "linear-gradient(135deg, #22c55e, #16a34a)", color: "white", boxShadow: "0 8px 24px rgba(34,197,94,0.4)" }}>
            {successMsg}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <div className="flex items-center gap-3 px-4 py-3.5 border-b" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
              ...
              <div className="flex-1">
                ...
                <input required value={formData.fullName} placeholder="Jan Janssen"
            ...
            <div className="flex items-center gap-3 px-4 py-3.5 border-b" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
              ...
              <div className="flex-1">
                ...
                <input required type="email" value={formData.email} placeholder="jan@email.com"
                  className="w-full bg-transparent text-white text-sm font-medium placeholder-white/20 focus:outline-none"
            ...
            <div className="flex items-center gap-3 px-4 py-3.5 border-b" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
              ...
              <div className="flex-1">
                ...
                <input required type="tel" value={formData.phone} placeholder="+32 4XX XX XX XX"
                  className="w-full bg-transparent text-white text-sm font-medium placeholder-white/20 focus:outline-none"
          ...
          <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl" style={{ background: "rgba(34,197,94,0.06)", border: "1px solid rgba(34,197,94,0.15)" }}>
            ...
            <p className="text-green-400/70 text-[10px] font-bold">
              {lang === "ar" ? "بياناتك محمية ومشفرة بالكامل" : lang === "nl" ? "Uw gegevens zijn volledig beveiligd en versleuteld" : "Vos données sont entièrement sécurisées"}
            </p>
          </div>
          ...
          <div className="w-full max-w-sm rounded-3xl overflow-hidden" style={{ background: "linear-gradient(160deg, #0d1b4b, #060818)", border: "1px solid rgba(255,255,255,0.1)" }}>
            <div className="px-6 pt-8 pb-6 text-center">
              ...
              <p className="text-white/50 text-sm mb-4 leading-relaxed">
                {lang === "ar" ? "لديك اشتراك نشط. لا يمكنك الاشتراك مجدداً حتى ينتهي اشتراكك الحالي."
                  : lang === "nl" ? "Je hebt al een actief abonnement. Je kunt niet opnieuw inschrijven."
