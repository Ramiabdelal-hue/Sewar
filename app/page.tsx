...
export default function HomePage() {
  ...
  return (
    <div style={{ height: "100dvh", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      {/* زر واتساب عائم */}
      <a href="https://wa.me/32470813725" target="_blank" className="wa-btn"
        style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 9999, width: '56px', height: '56px',
          borderRadius: '50%', backgroundColor: '#25D366', display: 'flex', alignItems: 'center',
          justifyContent: 'center', boxShadow: '0 4px 20px rgba(37,211,102,0.5)' }}>
