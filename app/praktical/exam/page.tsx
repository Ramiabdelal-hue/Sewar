...
import { FaEye, FaLock, FaClock, FaEnvelope } from "react-icons/fa";
...
function ExamContent() {
  ...
  const hazardTests = [
    { key: "hazardTest1", nl: "Gevaarherkenning - Stedelijk verkeer" },
    { key: "hazardTest2", nl: "Gevaarherkenning - Snelweg" },
    { key: "hazardTest3", nl: "Gevaarherkenning - Landelijke wegen" },
    { key: "hazardTest4", nl: "Gevaarherkenning - Kruispunten" },
    { key: "hazardTest5", nl: "Gevaarherkenning - Voetgangers" },
    { key: "hazardTest6", nl: "Gevaarherkenning - Fietsers" },
    { key: "hazardTest7", nl: "Gevaarherkenning - Slecht weer" },
    { key: "hazardTest8", nl: "Gevaarherkenning - Nacht rijden" },
    { key: "hazardTest9", nl: "Gevaarherkenning - Kinderen" },
    { key: "hazardTest10", nl: "Gevaarherkenning - Dieren" },
    { key: "hazardTest11", nl: "Gevaarherkenning - Werkzaamheden" },
    { key: "hazardTest12", nl: "Gevaarherkenning - Examen simulatie" }
  ];
      ...
      <div className="p-6 md:p-10">
        ...
        <header className="mb-12 text-center">
          <h1 className="text-4xl font-black text-gray-900 mb-4 italic uppercase">
            {lang === "ar" ? "إدراك المخاطر" : lang === "nl" ? "Gevaarherkenning" : "Perception des dangers"}
          </h1>
        ...
        <div className="mb-6">
          <input 
            type="text" 
            placeholder={lang === "ar" ? "ابحث عن اختبار..." : lang === "nl" ? "Zoek een test..." : "Rechercher un test..."} 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {hazardTests.filter(test => t[test.key].toLowerCase().includes(searchTerm.toLowerCase())).map((test, i) => (
            <div
              key={i}
              onClick={() => router.push(`/lesson?title=${encodeURIComponent(test.nl)}&type=hazard`)}
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-red-900 to-orange-900 flex items-center justify-center relative">
                <FaEye className="text-white text-5xl opacity-80 group-hover:scale-110 transition-all" />
                <div className="absolute top-4 right-4 bg-red-500 text-white px-3 py-1 rounded-full text-xs font-bold">
                  {lang === "ar" ? "اختبار" : lang === "nl" ? "Test" : "Test"} {i + 1}
                </div>
              </div>
              <div className="p-6 text-right">
                <h3 className="font-bold text-gray-800 text-lg">{t[test.key]}</h3>
                <p className="text-gray-400 text-xs mt-2 italic">
                  {lang === "ar" ? "تمارين إدراك المخاطر" : lang === "nl" ? "Gevaarherkenning oefeningen" : "Exercices de perception"}
                </p>
              </div>
            </div>
          ))}
